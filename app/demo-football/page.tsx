    ...
    <div style={{ background: "#07090f", color: "#fff", fontFamily: "'Inter', -apple-system, sans-serif", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <section className="hero-section" style={{ minHeight: "100dvh", position: "relative", overflow: "hidden", paddingBottom: "72px" }}>
        ...
        <div className="hero-content" style={{
          ...
          {/* Logo */}
          <div className="hero-logo-wrap" style={{ position: "relative", width: "200px", height: "200px", marginBottom: "20px", animation: "heroLogoIn 1s cubic-bezier(0.34,1.4,0.64,1) 0.15s both" }}>
            <div style={{ position: "absolute", inset: "-28px", borderRadius: "50%", background: "radial-gradient(circle, rgba(37,99,235,0.45) 0%, transparent 70%)", filter: "blur(20px)" }} />
            <img
              src="/logo2.png"
              alt="FC Vaux-le-Pénil"
              className="hero-logo"
              style={{ width: "200px", height: "200px", objectFit: "contain", position: "relative", zIndex: 1, filter: "drop-shadow(0 4px 24px rgba(0,0,0,0.8)) drop-shadow(0 0 40px rgba(37,99,235,0.3))" }}
            />
          </div>
