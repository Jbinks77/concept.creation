  ...
  return (
    <div style={{ background: "#060608", color: "#fff", fontFamily: "Georgia, serif", minHeight: "100vh" }}>
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: "18px 40px", display: "flex", justifyContent: "space-between", alignItems: "center", background: "rgba(6,6,8,0.92)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(212,168,83,0.08)" }}>
        ...
        <a href="https://wa.me/33621235008?text=Bonjour%2C%20je%20cherche%20un%20site%20internet%20%C3%A0%20Meaux." style={{ padding: "10px 24px", background: "#d4a853", color: "#060608", fontSize: "0.75rem", letterSpacing: "0.15em", textDecoration: "none", textTransform: "uppercase" }}>Devis Gratuit</a>
      </nav>
      ...
      <section style={{ padding: "140px 24px 80px", textAlign: "center", borderBottom: "1px solid rgba(212,168,83,0.08)", background: "radial-gradient(ellipse at 50% 30%, rgba(212,168,83,0.06) 0%, transparent 55%)" }}>
        ...
        <a href="https://wa.me/33621235008?text=Bonjour%2C%20je%20souhaite%20cr%C3%A9er%20un%20site%20internet%20%C3%A0%20Meaux." style={{ display: "inline-block", padding: "16px 40px", background: "#d4a853", color: "#060608", fontSize: "0.8rem", letterSpacing: "0.18em", textDecoration: "none", textTransform: "uppercase" }}>
          Devis Gratuit — 24h
        </a>
      </section>
      ...
      <section style={{ padding: "60px 24px", textAlign: "center", background: "rgba(212,168,83,0.03)", border: "1px solid rgba(212,168,83,0.08)" }}>
        ...
        <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
          <a href="https://wa.me/33621235008?text=Bonjour%2C%20je%20veux%20un%20site%20internet%20%C3%A0%20Meaux." style={{ padding: "16px 36px", background: "#d4a853", color: "#060608", fontSize: "0.78rem", letterSpacing: "0.18em", textDecoration: "none", textTransform: "uppercase" }}>WhatsApp</a>
